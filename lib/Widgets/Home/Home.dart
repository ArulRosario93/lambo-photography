  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("V Studios", style: GoogleFonts.poppins(textStyle: TextStyle(fontSize: 19, color:  Colors.black87, fontWeight: FontWeight.w500)),),
        toolbarHeight: 67.0,
      ),
      body: loaderScreen
      ...
      bottomNavigationBar: loaderScreen? BottomNavigationBar(
